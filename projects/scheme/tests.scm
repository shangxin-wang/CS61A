...
(quote Scheme-is-hard)
; expect scheme-is-hard
...
(quote (9 (i love Denero three (4 (5 8000934738)))))
; expect (9 (i love denero three (4 (5 8000934738))))

(cdr (car (quote (lst1 car cdr))))
; expect Error

(cdr (quote (c 8)))
; expect (8)

`(MY-GSI-IS-Jerry ,(lambda (x) (Jerry-is-very-nice)))
; expect (my-gsi-is-jerry (lambda (x) (jerry-is-very-nice)))
...
(begin (+ 6 3) (- 5 10) (/ 1 0) (* 1 0))
; expect Error

(begin (- 3 3) (* 10 9))
; expect 90

(define (function x) (* x (- 1 0)))
; expect function

(and)
; expect #t

(and 10000 5 (lambda (x) (+ x 2)))
; expect (lambda (x) (+ x 2))

(and 4 5 (/ 4 0))
; expect Error

(and ldldlddlld #f 42 (/ 1 0))
; expect Error
...
(define function (mu () (* x x)))
; expect function

(define g (lambda () (define a 4) (define b 5) (function)))
; expect g
